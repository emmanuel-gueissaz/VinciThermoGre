...
public class Mesure {
	...
	/**
	 * True si la températeur est au-dessus de la température max ou en-dessous de la température minimal
	 */
	...
	public String toString() {
		return "Mesure [numZone=" + numZone + ", horoDate=" + horoDate + ", fahrenheit=" + fahrenheit + ", notGood="+ notGood +"]";
	}
